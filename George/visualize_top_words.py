...
def main():
    ...
    parser.add_argument("--input_txt", required=True, help="Path to top_words_by_topic_and_role.txt")
    parser.add_argument("--output_dir", required=True, help="Directory for generated visuals")
